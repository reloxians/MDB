...
<br>
	...
	<table width="100%" cellpadding="5">
			...
			<form action="websites_cart" method="POST">			
			...
			<select name="category" required="required">
				<option value="">Select A Website Category</option>
				<option value="E-Commerce">E-Commerce</option>
				<option value="Church Websites">Church Websites</option>
				<option value="Corporate Websites">Corporate Websites</option>
				<option value="Business Website">Business Websites</option>
				<option value="QandA Website">Q&A Websites</option>
				<option value="Other Website">Other Websites</option>
			</select>
