<?php
	...
	//vars
						...
						$price_link = 'https://reloxians.com/pricing/apps/webapps';
		
//		echo $details['admin_email'];

	//insert 
	
	$ins = "insert into app_service_request (username,firstname,lastname, email, phone, country, description, category, charge, ref ) values ('$username', '$firstname', '$lastname', '$email', '$phone', '$country', '$desc', '$category', '$charge', '$ref') ";
