...
<div class="list_text">
This package is suitable for a standard online shop with <span class="email">Cart Functionality</span> & lot more
</div>
...
<div class="subject">
Multiple items to checkout page
</div>
...
<br>
	...
	<form method="post" action="/checkout/">	
		<input name="item" type="hidden" value="S-E-Commerce" />
...
<div class="list_text">
This package is suitable for small e-commerce businesses just starting up, making their <span class="email">First Appearance</span> on the internet
</div>
...
<br>
		...
		<form method="post" action="/checkout/">	
		<input name="item" type="hidden" value="B-E-Commerce" />
		<input name="type" type="hidden"value="website" />
