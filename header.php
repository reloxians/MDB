...
<script>
  ...
  gtag('config', 'UA-103139992-6');
    ...
    <meta property="og:image" content="https://reloxians.com/media/images/favicon.ico" />
  ...
  <link rel="stylesheet" href="/assets/disqus/asserts/disqus.css?<? echo date("Y-m-d h:i:sa");?>" />
    ...
    <script src="https://js.paystack.co/v1/paystack.js?<? date("Y-m-d h:i:sa");?>"></script>
     ...
     <link rel="stylesheet" href="/media/css/style.css?<? echo date("Y-m-d h:i:sa");?>"  type="text/css" />
   		...
   		<link href="//db.onlinewebfonts.com/c/dbefec3cdaf7f68b7f3a7ad7815b6497?family=Fiendstar+W01+Semibold" rel="stylesheet" type="text/css"/>
   ...
   <link href="https://fonts.googleapis.com/css?family=Catamaran:500|Merriweather+Sans" rel="stylesheet">		
