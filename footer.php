...
<h3 class="foot_name">Payment Gateways</h3>

<div class="foot_gateways"><ul class="payments">
...
<div class="">
Copyright © 2017 - <?php echo date("Y") ?> Top Web Developers & Designers – <a class="site_name" href="#"><?php echo site_name() ?>  <i class="fa fa-external-link"></i></a>   All Rights Reserved.
</div>
